...
function get_todos() {
    ...
    the web browswer to make the task a JavaScript object.*/
    if (todos_str !== null) {
...
/*this function keeps the tasks permanetyl displayed on the screen */
function show() {
...
/*This displays the inputed task when the 'Add Item' button us clicked*/
